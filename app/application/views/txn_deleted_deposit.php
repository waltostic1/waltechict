      ...
      <tr>
        ...
        <td style="vertical-align: top;">
          <div class="bg-light p-2">
            ...
            <h4 class="p-3">Deleted deposit | deleted by admin</h4>
              <thead class="">
                <tr>
                  <th>#</th>
                  <th>Username</th>
              ...
              <tbody>
                ...
                <?php
                if ($fetch_deleted_deposit->num_rows() > 0) {
                  $sn = 0;
          ...
          <div class="">
            ...
            <table class="table table-bordered ">
              ...
              <td colspan="2" class="text-center">
                ...
                <button id="delete-txn" class="btn btn-danger btn-sm m-1 mdi mdi-delete-forever ">Delete forever</button>
...
<script>
  $(document).ready(function() {
    ...
    $("#delete-txn").click(function() {
      ...
      Swal.fire({
        title: '<h5>Deleted transactions are not recoverable</h5>',
        ...
        if (result.isConfirmed) {
          ...
          $.ajax({
            ...
            url: "<?php echo base_url('txn_deleted_deposit/deleteTxn'); ?>",
            method: 'POST',
            data: {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          $.ajax({
            ...
            url: "<?php echo base_url('txn_deleted_deposit/approveTxn'); ?>",
            method: 'POST',
            data: {
              cryptoId: cryptoId,
