      ...
      <tr>
        ...
        <td style="vertical-align: top;">
          <div class="bg-light p-2">
            ...
            <h4 class="p-3">Queried | problem deposit</h4>
              <thead class="">
                <tr>
                  <th>#</th>
                  <th>Username</th>
              ...
              <tbody>
                ...
                <?php
                if ($fetch_queried_deposit->num_rows() > 0) {
                  $sn = 0;
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          $.ajax({
            ...
            url: "<?php echo base_url('txn_queried_deposit/deleteTxn'); ?>",
            method: 'POST',
            data: {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          $.ajax({
            ...
            url: "<?php echo base_url('txn_queried_deposit/queryTxn'); ?>",
            method: 'POST',
            data: {
              depositorId: depositorId,
              txnId: txnId,
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          $.ajax({
            ...
            url: "<?php echo base_url('txn_queried_deposit/approveTxn'); ?>",
            method: 'POST',
            data: {
              cryptoId: cryptoId,
