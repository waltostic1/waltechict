    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="">
              <h4>Pending | unconfirmed deposit</h4>
            </div>
                ...
                <tbody>
                  ...
                  ?>
                      ...
                      <tr>
                        ...
                        <td><?= $dpt_date ?></td>
                        <td class="alert-primary"><button class="button-approve btn btn-sm btn-primary" data-sender-id="<?= $dpt_sender_id ?>" data-user-id="<?= $dpt_user_id ?>" data-dpt-amount="<?= $dpt_amount ?>" data-approve-id="<?= $dpt_id ?>">approve</button>
                          <button class="button-disapprove btn btn-sm btn-danger ml-1" data-sender-id="<?= $dpt_sender_id ?>" data-disapprove-id="<?= $dpt_id ?>">disapprove</button>
                    ...
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        $.ajax({
                          ...
                          url: "<?php echo base_url('pending_deposit/disapproveTxn'); ?>",
                          method: 'POST',
                          data: {
                            txnId: txnId,
                            txnSenderId: txnSenderId,
